...
# Current Status
Rustci is currently under active development. As you may have observed, certain tests are currently failing on riscv64. We are planning to establish a test cases baseline and implementing automated [cron monitoring](https://github.com/OERV-RVCI/rustci4rv/tree/master/summary-daily) to detect [regressions](https://github.com/rust-lang/gccjit.rs/pull/64) on the riscv64 as early as possible.
